      ...
      <div className="row">
        ...
        <div className="home-paragraph">
          <p>
            ...
            their experience might cause severe and lifelong consequences. There
            is no question that violence in communities inflicts serious mental
            health challenges on members. More than fifty percent of those who
            experience violence are diagnosed with severe mental problems.
            Usually, women who experience gender-based violence report
            depression, anxiety, and posttraumatic trauma throughout their
            ...
            communities. In addition, these effects not only their present and
            future, but also their families, children, and loved ones.{" "}
          </p>
        </div>
      </div>
      <div className="row">
        <div className="notes-1">
          ...
          <p>
            ...
            experience such violence are less likely to report it. In turn, this
            lack of justice might further prolong the mental health problems
